...
export default function Footer() {
  ...
  const socialLinks = [
    ...
    { icon: Instagram, href: 'https://www.instagram.com/azk.n_nixa', label: 'Instagram' },
  ];

  return (
    <footer className="py-8 border-t border-border bg-blue-900">
